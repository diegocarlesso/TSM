...
Última versão: [**v1.6.1**](https://github.com/diegocarlesso/TSM/releases/tag/v1.6.1) — nenhum instalador, é só baixar e rodar.

| Sistema | Arquivo | Como usar |
|---|---|---|
| Windows | [TSM-1.6.1-win-x64.zip](https://github.com/diegocarlesso/TSM/releases/download/v1.6.1/TSM-1.6.1-win-x64.zip) | **Recomendado.** Extraia uma vez, abre na hora dali em diante. |
| Windows | [TSM-1.6.1-win-portable-x64.exe](https://github.com/diegocarlesso/TSM/releases/download/v1.6.1/TSM-1.6.1-win-portable-x64.exe) | Executável único, mais lento para abrir (autoextrai a cada execução). |
| Linux | [TSM-1.6.1-linux-x86_64.AppImage](https://github.com/diegocarlesso/TSM/releases/download/v1.6.1/TSM-1.6.1-linux-x86_64.AppImage) | `chmod +x` e execute. |
| Linux | [TSM-1.6.1-linux-x64.tar.gz](https://github.com/diegocarlesso/TSM/releases/download/v1.6.1/TSM-1.6.1-linux-x64.tar.gz) | Pasta com o binário, se preferir extrair. |
...
| Windows | `TSM-1.6.1-win-x64.zip` | **Recomendado.** Mesma pasta do `win-unpacked`, zipada. Extraia uma vez e o app abre na hora dali em diante. |
| Windows | `TSM-1.6.1-win-portable-x64.exe` | Executável único (~86 MB), no estilo do MobaXterm Portable. Mais conveniente para levar num pendrive, mas mais lento: é um autoextraível NSIS que descompacta tudo para uma pasta temporária **toda vez que abre** — isso soma alguns segundos de espera e é parte do motivo dele chamar mais atenção do SmartScreen/Defender. |
| Linux | `TSM-1.6.1-linux-x86_64.AppImage` | Um arquivo só: `chmod +x` e execute. |
